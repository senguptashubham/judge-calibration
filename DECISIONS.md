...
**The repo goes public** (owner confirmed permission, 25 Sep 2026): code under MIT; text and figures under CC BY 4.0, matching the CC BY 4.0 MT-Bench data. The site is published from `site/` by `.github/workflows/pages.yml`.
