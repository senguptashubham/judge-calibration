...
Twenty-five decisions, D4–D28, resolving the review findings and (D18 onward) integrating the professor's 31 Aug 2026 feedback (`PROFESSORFEEDBACK.md`). D27 (22 Sep 2026) and D28 (23 Sep 2026) are later, owner-initiated additions — the industry-counterexample stress test and the purpose-built-judge generalization test — not part of the professor-feedback integration. Each is binding; copy the ones marked ⚑ into `PREREGISTRATION.md` before Gate 1. **D27 and D28 postdate `PREREGISTRATION.md`'s freeze (1 Sep 2026) and are not in it, same as D26.**
